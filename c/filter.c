...
{
	sos c;
	bwLpfOrHpfCoef(isHpf, sr, freq, rq, &c.a0, &c.a1, &c.a2, &c.b1, &c.b2);
	return c;
}
iir2 rlpf(R radiansPerSample, R freq, R rq)
{
	iir2 c;
	rlpfCoef(radiansPerSample, freq, rq, &c.a0, &c.b1, &c.b2);
	return c;
}
iir2 resonz(R radiansPerSample, R freq, R rq)
{
	iir2 c;
	resonzCoef(radiansPerSample, freq, rq, &c.a0, &c.b1, &c.b2);
	return c;
}
